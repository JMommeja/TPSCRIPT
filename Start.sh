...
if [ "$1" == "--build" ]; then
  ...
  exit 0
	 ...
	 if [[ `id -u` -ne 0 ]] ; then echo " Vous n'etes pas en Super Admin relancer le script en faisant ''Sudo Start.Bash'' Appuiez sur Entrer pour arreter le programme. " ; read ; exit 1 ; fi
